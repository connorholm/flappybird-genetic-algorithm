...
def fitness_func(ga_instance, solution, solution_idx):
    ...
    if (solution < pipeHeight + nearest_upper_pipe['y'] + 50 and abs(playerx - nearest_upper_pipe['x']) <
            GAME_SPRITES['pipe'][0].get_width() + 50):
    ...
    fitness_lower = abs(solution + GAME_SPRITES['player'].get_height() - nearest_lower_pipe[
        'y'])  # + abs(playerx - pipe['x']) - GAME_SPRITES['pipe'][0].get_width()
    if (solution + GAME_SPRITES['player'].get_height() > nearest_lower_pipe['y'] - 50) and abs(
            playerx - nearest_lower_pipe['x']) < GAME_SPRITES['pipe'][0].get_width() + 50:
